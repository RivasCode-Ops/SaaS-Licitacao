...
const OAUTH_ERRORS: Record<string, string> = {
  oauth_invalid: "Resposta inválida do provedor de autenticação.",
  oauth_state: "Estado inválido. Tente novamente.",
  oauth_no_account:
    "Nenhuma conta encontrada com este email. Peça a um administrador para criar sua conta primeiro.",
  account_inactive: "Sua conta está desativada.",
    ...
    <form action={formAction} className="space-y-4">
      ...
      {oauthError && (
        <p className="text-sm text-red-500">
          {OAUTH_ERRORS[oauthError] ?? "Erro desconhecido."}
        </p>
      )}
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <a
              ...
              className="flex items-center justify-center gap-2 rounded-lg border border-border px-3 py-2 text-sm hover:bg-accent transition-colors"
            >
